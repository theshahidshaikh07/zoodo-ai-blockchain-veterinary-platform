    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <motion.div
                ...
                className="inline-flex items-center px-4 py-2 rounded-full glass-card bg-white/10 dark:bg-black/10 backdrop-blur-md border border-primary/20 text-sm font-medium text-primary mb-6"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
                <motion.div
                  className="flex flex-col items-center text-center glass-card bg-white/10 dark:bg-black/10 backdrop-blur-md border border-primary/20 hover:border-primary/40 p-6 rounded-3xl shadow-lg transition-all duration-300 hover:scale-105"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2 }}
                >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              <motion.div
                ...
                className="glass-card bg-white/10 dark:bg-black/10 backdrop-blur-md border border-primary/20 shadow-lg p-8 md:p-10 rounded-3xl"
              >
        ...
        <div className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              className="h-96 w-full rounded-3xl overflow-hidden shadow-xl relative border border-primary/20"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
