            ...
            <DialogContent className="sm:max-w-md w-[90%] rounded-2xl border border-border bg-card/95 backdrop-blur-xl shadow-elegant">
                ...
                <div className="p-2 text-center space-y-6">
                    ...
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span><Link href="/salus" className="font-bold text-primary hover:underline hover:text-primary/80 transition-colors">Salus AI</Link> is fully operational & ready to help!</span>
                    </div>
                </div>
