...
const pillars = [
  {
    ...
    icon: Stethoscope,
    modes: [
      { icon: Video, label: "Online Consult", href: "/services?cat=care&tab=veterinary&type=online" },
      { icon: Home, label: "Home Visit", href: "/services?cat=care&tab=veterinary&type=home" },
      { icon: Building2, label: "In-Clinic", href: "/services?cat=care&tab=veterinary&type=clinic" },
      { icon: AlertTriangle, label: "Emergency", href: "/services?cat=care&tab=veterinary&type=emergency" },
      { icon: Syringe, label: "Vaccination", href: "/services?cat=care&tab=veterinary&type=clinic" },
      { icon: FlaskConical, label: "Lab Tests", href: "/services?cat=care&tab=veterinary&type=clinic" },
    ],
    cta: { label: "Explore Vet Care", href: "/services?cat=care&tab=veterinary" },
  },
  {
    id: "training",
